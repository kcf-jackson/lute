...
func _() {
	...
	_ = x[NodeWikiLink-580]
	_ = x[NodeWikiLinkOpenBracket-581]
	_ = x[NodeWikiLinkCloseBracket-582]
	_ = x[NodeWikiLinkTarget-583]
	_ = x[NodeWikiLinkSeparator-584]
	_ = x[NodeWikiLinkText-585]
	_ = x[NodeTypeMaxVal-1024]
}

const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	580:  _NodeType_name[2320:2332],
	581:  _NodeType_name[2332:2355],
	582:  _NodeType_name[2355:2379],
	583:  _NodeType_name[2379:2397],
	584:  _NodeType_name[2397:2418],
	585:  _NodeType_name[2418:2434],
	1024: _NodeType_name[2434:2448],
}
